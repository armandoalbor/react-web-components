...
function dr() {
  if (Se) return F;
  Se = 1;
  var P = Pe, _ = Symbol.for("react.element"), U = Symbol.for("react.fragment"), T = Object.prototype.hasOwnProperty, W = P.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, $ = { key: !0, ref: !0, __self: !0, __source: !0 };
  function j(y, c, w) {
    ...
    if (y && y.defaultProps) for (p in c = y.defaultProps, c) b[p] === void 0 && (b[p] = c[p]);
    return { $$typeof: _, type: y, key: E, ref: Y, props: b, _owner: W.current };
  }
...
function vr() {
  return Ce || (Ce = 1, process.env.NODE_ENV !== "production" && function() {
    var P = Pe, _ = Symbol.for("react.element"), U = Symbol.for("react.portal"), T = Symbol.for("react.fragment"), W = Symbol.for("react.strict_mode"), $ = Symbol.for("react.profiler"), j = Symbol.for("react.provider"), y = Symbol.for("react.context"), c = Symbol.for("react.forward_ref"), w = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), b = Symbol.for("react.memo"), E = Symbol.for("react.lazy"), Y = Symbol.for("react.offscreen"), re = Symbol.iterator, je = "@@iterator";
    function xe(e) {
    ...
    function $e(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === T || e === $ || We || e === W || e === w || e === p || Ie || e === Y || De || Fe || Ae || typeof e == "object" && e !== null && (e.$$typeof === E || e.$$typeof === b || e.$$typeof === j || e.$$typeof === y || e.$$typeof === c || // This needs to include all possible module reference object
    ...
    var R = Object.assign, x = 0, ae, ie, oe, ue, se, le, fe;
    function ce() {
    }
...
` + a[s].replace(" at new ", " at ");
        ...
        q = !1, B.current = u, Ve(), Error.prepareStackTrace = o;
      }
    ...
    var k = Object.prototype.hasOwnProperty, ve = {}, pe = O.ReactDebugCurrentFrame;
    function N(e) {
      if (e) {
    ...
    function Be(e, r, t, n, o) {
      {
        ...
        for (var i in e)
          if (u(e, i)) {
            ...
            a && !(a instanceof Error) && (N(o), f("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", n || "React class", t, i, typeof a), N(null)), a instanceof Error && !(a.message in ve) && (ve[a.message] = !0, N(o), f("Failed %s type: %s", t, a.message), N(null));
          }
      }
    }
    ...
    function rr(e, r, t, n, o) {
      {
        ...
        t !== void 0 && (he(t), a = "" + t), Xe(r) && (he(r.key), a = "" + r.key), ze(r) && (d = r.ref, He(r, o));
        for (u in r)
    ...
    var z = O.ReactCurrentOwner, ye = O.ReactDebugCurrentFrame;
    function S(e) {
      if (e) {
        var r = e._owner, t = M(e.type, e._source, r ? r.type : null);
    ...
    function me(e, r) {
      {
        ...
        Re[t] = !0;
        var n = "";
        e && e._owner && e._owner !== z.current && (n = " It was passed a child from " + h(e._owner.type) + "."), S(e), f('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', t, n), S(null);
      }
    }
    function Te(e, r) {
      {
    ...
    function Oe(e, r, t, n, o, u) {
      {
        ...
        if (!i) {
          ...
          d ? a += d : a += Ee();
          var s;
          e === null ? s = "null" : K(e) ? s = "array" : e !== void 0 && e.$$typeof === _ ? (s = "<" + (h(e.type) || "Unknown") + " />", a = " Did you accidentally export a JSX literal instead of a component?") : s = typeof e, f("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", s, a);
        }
        var l = rr(e, r, t, o, u);
        if (l == null)
          return l;
...
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, Z, m, fr, m), we[m + Z] = !0;
          }
        }
    ...
    var sr = ur, lr = or;
    A.Fragment = T, A.jsx = sr, A.jsxs = lr;
  }()), A;
}
process.env.NODE_ENV === "production" ? ee.exports = dr() : ee.exports = vr();
var I = ee.exports;
const pr = "_wrapper_5bkbt_1", gr = "_logo_5bkbt_19", hr = "_title_5bkbt_33", Q = {
  wrapper: pr,
  logo: gr,
  title: hr
}, _r = ({ text: P, image: _ }) => /* @__PURE__ */ I.jsx("header", { children: /* @__PURE__ */ I.jsxs("div", { className: Q.wrapper, children: [
  /* @__PURE__ */ I.jsx("div", { children: /* @__PURE__ */ I.jsx("img", { width: 150, height: 150, className: Q.logo, src: _ }) }),
  /* @__PURE__ */ I.jsx("h1", { className: Q.title, children: P })
] }) });
export {
  _r as Header
};
